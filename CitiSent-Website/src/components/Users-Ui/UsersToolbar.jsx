    ...
    <div className="flex flex-col gap-4 border-b border-slate-200 p-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between dark:border-slate-700/80">
      ...
      <div className="flex flex-wrap items-center gap-2 sm:gap-3">
        ...
        <button
          ...
          className="ml-auto inline-flex items-center gap-2 rounded-xl bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all duration-300 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500/50 disabled:cursor-not-allowed disabled:bg-slate-300 disabled:shadow-none dark:disabled:bg-slate-700 dark:disabled:text-slate-500"
        >
          <FiPlus />
          {primaryAction}
        </button>
