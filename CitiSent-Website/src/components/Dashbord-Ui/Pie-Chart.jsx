	...
	return (
		<div className="h-full rounded-lg bg-white p-6 shadow-sm border border-slate-200 flex flex-col">
			...
			<div className="flex flex-1 flex-col items-center gap-4">
				...
				<div className="grid w-full grid-cols-2 justify-items-start gap-2 text-xs text-slate-600">
					{legend.map((item, index) => {
						...
						return (
							<div
								key={item.label}
								className={`flex items-center gap-2 ${isLastOdd ? 'col-span-2 justify-center' : ''}`}
							>
